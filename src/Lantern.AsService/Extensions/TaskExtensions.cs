...
internal static class TaskExtensions
{
    ...
    public static async Task<TResult> WithCancellation<TResult>(this Task<TResult> task, TimeSpan timeout, CancellationToken cancellationToken)
    {
        if (timeout <= TimeSpan.Zero)
        {
            return await WithCancellation(task, cancellationToken).ConfigureAwait(false);
        }
    ...
    private static void IgnoreException(this Task task)
    {
