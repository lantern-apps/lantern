namespace WinFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        protected override async void OnLoad(EventArgs e)
        {
            ...
            webView21.CoreWebView2.NavigationStarting += (o, e) => Console.WriteLine($"Navigate Starting {e.NavigationId} {e.Uri} {e.IsRedirected}");

            webView21.CoreWebView2.ContentLoading += (o, e) => Console.WriteLine($"Content Loading {e.NavigationId}");
            webView21.CoreWebView2.DOMContentLoaded += (o, e) => Console.WriteLine($"DOMContent Loaded {e.NavigationId}");

            webView21.CoreWebView2.NavigationCompleted += (o, e) => Console.WriteLine($"Navigate Completed {e.NavigationId} {e.HttpStatusCode}");
        ...
        {
            webView21.CoreWebView2.Navigate(TbUrl.Text);
        }
